  ...
  const initChart = () => {
    ...
    const initOption = {
      ...
      legend: {
        ...
        fontSize: 11,
        data: [],
        type: containerWidth < 400 ? 'scroll' : 'plain',
        orient: containerWidth < 400 ? 'vertical' : 'horizontal',
        right: containerWidth < 400 ? '5' : undefined,
        top: containerWidth < 400 ? '15' : undefined
      },
      series: [
        {
          name: '分类',
          ...
          center: ['50%', containerWidth < 400 ? '40%' : '33%'],
          data: [],
          itemStyle: {
