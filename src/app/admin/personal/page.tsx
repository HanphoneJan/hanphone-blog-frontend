...
export default function ProfilePage() {
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
      {/* 背景效果 */}
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto lg:px-2 lg:py-2 relative z-10">
        {/* 顶部标签式导航 */}
        <div className="bg-slate-800/40 backdrop-blur-sm lg:rounded-t-xl shadow-lg border border-slate-700/50 border-b-0 overflow-hidden">
              ...
              <button
                ...
                className={`flex-1 min-w-[50px] px-2 pt-2 pb-1 lg:py-3 transition-all ${
                  activeSection === item.id
                    ...
                    : 'bg-slate-800/40 text-slate-300 hover:bg-slate-700/40 border-b-2 border-transparent'
                }`}
              >
                {/* 桌面端显示 */}
        ...
        {/* 基本信息部分 - 合并用户信息与编辑表单 */}
        {activeSection === 'info' && (
          <div className="bg-slate-800/40 backdrop-blur-sm rounded-b-xl shadow-lg border border-slate-700/50 border-t-0 overflow-hidden">
            <div className="py-3 px-6 border-b border-slate-700/50">
              <h2 className="text-lg font-semibold text-blue-100 flex items-center">
            ...
            <div className="p-2 lg:p-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
                ...
                <div className="lg:col-span-3 relative self-center">
                  <div className="relative w-32 h-32 rounded-full overflow-hidden border-2 border-slate-700 mx-auto lg:ml-20">
                    <Image
                    ...
                    />
                    <div
                      className="absolute inset-0 bg-black/30 rounded-full border-2 border-slate-700 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity cursor-pointer"
                      onClick={() => {
                ...
                <div className="lg:col-span-9 flex flex-col gap-2">
                  ...
                  <form className="space-y-5">
                    ...
                    <div className="flex items-center gap-4">
                      <label className="text-sm text-slate-400 min-w-[80px]">用户类型</label>
                      <div className="flex-1  max-w-sm">
                        <div className="text-slate-200 p-2 bg-slate-900/60 rounded-lg border border-slate-700">
                    ...
                    {/* 昵称 */}
                    <div className="flex items-center gap-4">
                      <label htmlFor="nickname" className="text-sm text-slate-400 min-w-[80px]">
                        昵称
                      </label>
                      <div className="flex-1 max-w-sm">
                        <input
                          ...
                          className="w-full px-4 py-2 rounded-lg border border-slate-700 bg-slate-900/60 text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                          required
                        />
                      </div>
                    </div>
                    ...
                    {/* 用户名 */}
                    <div className="flex items-center gap-4">
                      <label htmlFor="username" className="text-sm text-slate-400 min-w-[80px]">
                        用户名
                      </label>
                      <div className="flex-1  max-w-sm">
                        <input
                    ...
                    {/* 邮箱 */}
                    <div className="flex items-center gap-4">
                      <label htmlFor="email" className="text-sm text-slate-400 min-w-[80px]">
                        邮箱
                      </label>
                      <div className="flex-1  max-w-sm">
                        <input
        ...
        {activeSection === 'skills' && (
          <div className="bg-slate-800/40 backdrop-blur-sm rounded-b-xl shadow-lg border border-slate-700/50 border-t-0 overflow-hidden">
            <div className="py-3 px-6 border-b border-slate-700/50 flex justify-between items-center">
              <h2 className="text-lg font-semibold text-blue-100 flex items-center">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-sm flex items-center transition-colors"
              >
            ...
            <div className="p-2 lg:p-4 min-h-[90vh]">
              {loading ? (
                ...
                <div className="text-center py-10 text-slate-400">暂无技能数据</div>
              ) : (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {skills.map((skill, index) => (
                    <div
                      key={skill.id}
                      className="flex flex-col items-center text-center p-3 bg-slate-800/60 rounded-lg border border-slate-700/50 hover:bg-slate-800 transition-all duration-300 relative 
                    ...
                    >
                      <button
                        ...
                        className="absolute top-2 right-2 text-slate-500 hover:text-red-500 transition-colors
                              sm:top-2 sm:right-2 sm:h-4 sm:w-4"
                        aria-label="删除技能"
                      >
                      ...
                      <button
                        ...
                        className="absolute top-2 left-2 text-slate-500 hover:text-blue-500 transition-colors
                              sm:top-2 sm:left-2 sm:h-4 sm:w-4"
                        aria-label="编辑技能"
                      >
                      ...
                      <div
                        className="w-16 h-16 sm:w-18 sm:h-18 
                                bg-slate-700/60 rounded-full shadow-md flex items-center justify-center 
                                mb-2 sm:mb-3 transition-all duration-300 hover:shadow-lg hover:scale-110"
                      >
                        {skill.icon}
                      </div>

                      <h3 className="text-sm sm:text-base font-semibold mb-1 text-blue-100">
                        {skill.name}
                      </h3>

                      <p className="text-xs sm:text-sm text-slate-300 line-clamp-2">{skill.desc}</p>
          ...
          <div className="bg-slate-800/40 backdrop-blur-sm rounded-b-xl shadow-lg border border-slate-700/50 border-t-0 overflow-hidden">
            ...
            <div className="p-2 lg:p-4 min-h-[90vh]">
              {loading ? (
                ...
                <div className="text-center py-10 text-slate-400">暂无作品数据</div>
              ) : (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {works.map((work, index) => (
                    <div
                      key={work.id}
                      className="bg-slate-800/60 rounded-xl border border-slate-700/50 overflow-hidden transition-all duration-300 hover:bg-slate-800 hover:shadow-lg relative
                    ...
                    >
                      ...
                      <div className="p-3">
                        <div className="flex items-center mb-2">
                          <span className="mr-2 text-blue-400">{work.icon}</span>
                          <h3 className="text-sm sm:text-base font-semibold text-blue-100">
                            {work.name}
                          </h3>
                        </div>
          ...
          <div className="bg-slate-800/40 backdrop-blur-sm rounded-b-xl shadow-lg border border-slate-700/50 border-t-0 overflow-hidden">
            ...
            <div className="p-2 lg:p-4 min-h-[90vh]">
              {loading ? (
                ...
                <div className="text-center py-10 text-slate-400">暂无爱好数据</div>
              ) : (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {hobbys.map((hobby, index) => (
                    ...
                    >
                      ...
                      <div className="p-3">
                        <div className="flex items-center mb-2">
                          <span className="mr-2 text-blue-400">{hobby.icon}</span>
                          <h3 className="text-sm sm:text-base font-semibold text-blue-100">
                            {hobby.name}
                          </h3>
                        </div>
          ...
          <div className="bg-slate-800/40 backdrop-blur-sm rounded-b-xl shadow-lg border border-slate-700/50 border-t-0 overflow-hidden">
            ...
            <div className="p-2 lg:p-4 min-h-[90vh]">
              {loading ? (
                ...
                <div className="text-center py-10 text-slate-400">暂无评价数据</div>
              ) : (
                <div className="space-y-3">
                  {selfEvaluations.map((evaluation, index) => (
                    <div
                      key={evaluation.id}
                      className="bg-slate-800/60 rounded-lg border border-slate-700/50 p-3 relative hover:bg-slate-800 transition-all duration-300"
                    >
                      <button
                      ...
                      <button
                        ...
                        className="absolute top-3 right-10 text-slate-500 hover:text-blue-500 transition-colors"
                      >
                        <Edit3 className="h-4 w-4" />
                      </button>
                      <p className="text-slate-200 leading-relaxed pl-2 border-l-2 border-blue-500">
                        {evaluation.name}
                      </p>
                    </div>
                  ))}
        ...
        {dialogVisible && (
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-slate-800 rounded-xl border border-slate-700 w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-200 max-h-[80vh] flex flex-col">
              <div className="px-5 py-3 border-b border-slate-700 flex justify-between items-center flex-shrink-0">
              ...
              <div className="px-5 py-4 overflow-y-auto flex-1">
                {activeSection === 'avatar' ? (
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="flex items-center justify-center w-full px-4 py-2 border border-slate-700 rounded-lg cursor-pointer bg-slate-900/60 text-slate-200 hover:bg-slate-800 transition-colors">
                  ...
                  <div className="space-y-4">
                    {activeSection === 'skills' && (
                      <>
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">技能链接</label>
                          <input
                            name="url"
                            type="url"
                            value={formData.url || ''}
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">技能类型</label>
                          <input
                            name="icon_src"
                            type="text"
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">技能描述</label>
                          <textarea
                            name="desc"
                            value={formData.desc || ''}
                            onChange={handleInputChange}
                            className="w-full px-4 py-2 rounded-lg border border-slate-700 bg-slate-900/60 text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all min-h-[100px]"
                            placeholder="输入技能描述"
                          />
                        </div>
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">排序优先级</label>
                          <input
                            name="rank"
                            type="text"
                            value={formData.rank || ''}
                    ...
                    {activeSection === 'works' && (
                      <>
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">作品名称</label>
                          <input
                            name="name"
                            type="text"
                            value={formData.name || ''}
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">作品类型</label>
                          <input
                            name="icon_src"
                            type="text"
                            value={formData.icon_src || ''}
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">作品链接</label>
                          <input
                            name="url"
                            type="url"
                            value={formData.url || ''}
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">作品图片URL</label>
                          <input
                            name="pic_url"
                            type="text"
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">作品描述</label>
                          <textarea
                            name="desc"
                            value={formData.desc || ''}
                            onChange={handleInputChange}
                    ...
                    {activeSection === 'hobbys' && (
                      <>
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">爱好名称</label>
                          <input
                            name="name"
                            type="text"
                            value={formData.name || ''}
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">爱好类型</label>
                          <input
                            name="icon_src"
                            type="text"
                            value={formData.icon_src || ''}
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">相关链接</label>
                          <input
                            name="url"
                            type="url"
                            value={formData.url || ''}
                        ...
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">爱好描述</label>
                          <textarea
                            name="desc"
                            value={formData.desc || ''}
                            onChange={handleInputChange}
                    ...
                    {activeSection === 'evaluations' && (
                      <>
                        <div>
                          <label className="block text-sm text-slate-400 mb-1">个人评价内容</label>
                          <textarea
                            name="name"
                            value={formData.name || ''}
                            onChange={handleInputChange}
                            className="w-full px-4 py-2 rounded-lg border border-slate-700 bg-slate-900/60 text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all min-h-[150px]"
                            placeholder="输入评价内容"
                            required
                          />
                        </div>
              ...
              <div className="px-5 py-3 border-t border-slate-700 flex justify-end gap-3 flex-shrink-0">
                <button
                  onClick={closeDialog}
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-slate-800 rounded-xl border border-slate-700 w-full max-w-md overflow-hidden">
              <div className="p-5 border-b border-slate-700 flex justify-between items-center">
                <h3 className="text-lg font-semibold text-blue-100">重置密码</h3>
                <button
                  onClick={() => {
                    setResetPasswordVisible(false)
                    setNewPassword('')
              ...
              <div className="p-4 border-t border-slate-700 flex justify-end gap-3">
                <button
                  ...
                  className="px-4 py-2 rounded-lg border border-slate-700 bg-slate-800 hover:bg-slate-700 text-slate-200 transition-colors"
                >
                  取消
                </button>
                <button
